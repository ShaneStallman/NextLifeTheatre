  ...
  return (
    <div>
      <div className="aboutBlock" id="about">
        ...
        <br/>
        With <em>Carmilla</em>, Next Life is seeking to tell an old story that frames queerness as predatory in a new way that embraces not only the joy and heartache of authentic queer romance, but to tell it in a way that feels authentic to the queer community.<br/>
        <br/>
